        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer"
              ...
              <span className="font-semibold text-neutral">Twitter</span>
            </a>

            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer"
               className="flex items-center gap-3 bg-base border-2 border-neutral/10 px-8 py-4 rounded-full hover:border-highlight hover:bg-highlight/5 transition-all">
              ...
              <span className="font-semibold text-neutral">YouTube</span>
            </a>
          </div>
        </div>
      </section>
