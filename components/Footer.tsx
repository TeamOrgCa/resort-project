        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-base/70">
              ...
              <li>Hapay na Mangga, Brgy. Dolores</li>
              <li>Philippines, 1920</li>
              <li className="pt-2">Phone: 0917 279 6592 / 8236 0633</li>
              <li>Email: emailmarvilleresort@gmail.com</li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              <a
                href="https://facebook.com/marvilleresort"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MarVille Resort on Facebook"
                className="w-10 h-10 bg-base/20 rounded-full flex items-center justify-center hover:bg-highlight/30 transition-colors"
              >
                <svg className="w-5 h-5 fill-current text-base" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a
                href="https://instagram.com/marvilleresort"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MarVille Resort on Instagram"
                className="w-10 h-10 bg-base/20 rounded-full flex items-center justify-center hover:bg-highlight/30 transition-colors"
              >
                <svg className="w-5 h-5 fill-current text-base" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                href="https://tiktok.com/@marvilleresort"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="MarVille Resort on TikTok"
                className="w-10 h-10 bg-base/20 rounded-full flex items-center justify-center hover:bg-highlight/30 transition-colors"
              >
                <svg className="w-5 h-5 fill-current text-base" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M16.6 5.82a5.6 5.6 0 0 1-1.39-3.63h-3.06v12.24a2.56 2.56 0 1 1-2.56-2.56c.18 0 .35.02.52.05V8.8a5.89 5.89 0 1 0 4.49 5.72V9.1a8.36 8.36 0 0 0 4.54 1.34V7.38a5.57 5.57 0 0 1-2.54-.56z" />
                </svg>
              </a>
            </div>
          </div>
